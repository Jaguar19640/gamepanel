...
# ⚠️ KEIN LÖSCHEN VON UFW-REGELN MEHR!
# Die Firewall-Konfiguration wird nur von GamePanel verwaltet,
# wenn Server gestartet/gestoppt werden. Bestehende Regeln bleiben erhalten.
info "⏭️ Firewall-Konfiguration wird NICHT verändert (respektiere bestehende Regeln)"
